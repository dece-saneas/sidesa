...
@section('title') Edit Carousel @endsection
@section('content')
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="jumbotron s-container-title">
				<h1 class="display-4">Edit Carousel</h1>
				...
				@csrf @method('PUT')
					<div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{ asset('img/carousels/'.$carousel->image) }}" alt="Article Image" class="img-fluid img-thumbnail w-100 img-article" id="upfile-article" style="cursor:pointer; width: 1760px; height: 500px" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('content') is-invalid @enderror" id="summernote" name="content">{{ $carousel->content }}</textarea>
                                @error('content')
