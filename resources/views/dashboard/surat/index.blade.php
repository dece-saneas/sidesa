	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="jumbotron s-container-title">
				<h1 class="display-4">Permohonan Surat</h1>
		...
		<div class="container-fluid">
			<div class="text-right mb-4">
				<div class="btn-group mb-2">
                    @can('surat-create')
					<a href="{{ route('surat.create') }}" class="btn btn-success"><i class="fas fa-plus-circle mr-2"></i>Tambah</a>
                    @endcan
					<a href="{{ route('surat') }}" class="btn btn-dark" id="refresh"><i class="fas fa-sync-alt mr-2 refresh"></i>Refresh</a>
				</div>
			</div>
			@if (count($surat) > 0)
			<div class="card">
