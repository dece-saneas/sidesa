	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="jumbotron s-container-title">
				<h1 class="display-4">Create Mission</h1>
				...
				@csrf
					<div class="card-body">
                        <div class="form-group row">
                            <label for="content" class="col-sm-2 col-form-label">Mission</label>
                            <div class="col-sm-10">
                    ...
                    <div class="card-body">
                        <div class="float-right">
                            <button class="btn btn-success" type="submit"><i class="fas fa-plus mr-2"></i>Create Mission</button>
                        </div>
